...
import product1 from "../assets/image/mobile.jpeg";
...
const products = [
  ...
  },
  {
    ...
    price: 860,
    image: product3,
    desc: "Experience sleek performance and elegant design with the Macbook Pro – your perfect everyday companion for work, creativity, and entertainment. Featuring a vibrant 13.5 PixelSense™ touchscreen display with ultra-slim bezels, this laptop delivers stunning visuals and responsive interaction, whether you're browsing, sketching, or streaming. Powered by the latest Intel® Core™ processor and equipped with fast SSD storage, it offers smooth multitasking, quick boot times, and efficient performance for students, professionals, and creators alike. Its lightweight, ultra-thin aluminum build makes it easy to carry, while the all-day battery life ensures productivity on the go. The keyboard is designed for comfortable typing with precision and quiet keys, and the large trackpad offers smooth navigation. With built-in MacOS 11, seamless Apple environment integration, and strong security features like facial recognition, this laptop is built to keep you connected, productive, and secure. Whether you're attending virtual meetings, designing graphics, or writing reports, the Macbook Pro offers premium performance wrapped in a minimalist and modern aesthetic. Ready to redefine your workflow and boost your creativity – all in one powerful and portable package.",
  },
];
